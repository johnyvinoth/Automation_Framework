...
//        WebUtils.pressEnterButton(driver);
        ...
        // is still holding driver created for chrome so the elements are not getting identified
        // and if firefox alone exectuedthen elements are getting located without any issue.
